      ...
      <div class="authentication-wrapper authentication-basic container-p-y">
        <div class="authentication-inner py-4">
          <div class="card">
            ...
            <p class="mb-4">
                Google Authenticator adalah autentikator berbasis perangkat lunak oleh Google.
            </p>

              <form id="formAuthentication" class="mb-3" method="POST" action="{{ route('google.validation.2fa') }}">
                @csrf

                <div class="mb-3">
                  <label for="otp" class="form-label">Code OTP Google 2FA</label>
                  <input id="otp" type="otp" class="form-control @error('otp') is-invalid @enderror" name="otp" autocomplete="off" placeholder="OTP Code Google 2FA..." autofocus>
              ...
              <div class="text-center">
                <a class="d-flex align-items-center justify-content-center btn btn-outline-secondary" href="{{ route('logout') }}" onclick="event.preventDefault();
