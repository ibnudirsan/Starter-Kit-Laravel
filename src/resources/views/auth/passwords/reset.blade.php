...
<head>
    ...
    <title>Reset Password | Raungdev</title>
            ...
            <div class="card-body shadow rounded">
              ...
              <div class="app-brand justify-content-center">
                <a href="{{ route('login') }}" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder">Raungdev</span>
                </a>
              </div>
              ...
              <form id="formAuthentication" class="mb-3" method="POST" action="{{ route('password.update') }}">
                ...
                <div class="mb-3">
                  ...
                  <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ $email ?? old('email') }}" required autocomplete="off" placeholder="Enter your email" autofocus>
